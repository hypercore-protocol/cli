...
${chalk.bold(`Hyperdrive Commands:`)}
  ...
  ${chalk.bold(`hk drive create`)} - Create a new hyperdrive.
...
${chalk.bold(`Hyperbee Commands:`)}
  ...
  ${chalk.bold(`hk bee create`)} - Create a new hyperbee.
  ...
  ${chalk.bold(`hk bee del`)} {url} - Delete an entry of the given hyperbee URL.
